  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <Card className="p-6" data-testid="card-contact-whatsapp">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href={info.whatsappLink} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-[#25D366] transition-colors" data-testid="link-contact-whatsapp" onClick={(e) => handleWhatsAppClick(e, `${isBG ? "/bg" : ""}/thank-you`, lang)}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg h-[400px]">
            <iframe
              ...
              title="Dental Clinic Lina Location"
            />
          </div>
        </div>
      </section>
      ...
      <a
        ...
        onClick={(e) => handleWhatsAppClick(e, `${isBG ? "/bg" : ""}/thank-you`, lang)}
      >
